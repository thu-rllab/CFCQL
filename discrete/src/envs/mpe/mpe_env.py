...
class MPEEnv(gym.Env):
    ...
    def __init__(self, world, reset_callback=None, reward_callback=None,
                 ...
                 done_callback=None, shared_viewer=True,episode_limit=None,**kwargs):
        ...
        for agent_idx, agent in enumerate(self.agents):
            ...
            # observation space
            obs_dim = len(observation_callback(agent_idx, self.world))
        ...
        self.obs_size = self.observation_space[0].shape[0]
    ...
    def get_env_info(self):
        ...
        info['observation_space']=self.get_observation_space()
        info['action_space']= self.get_action_space()
        # info['agent_num_infos']=self.get_agent_num_infos()
        return info
    ...
    def get_obs(self):
        ...
        obs_n = []
        for agent_idx, agent in enumerate(self.agents):
            obs_n.append(self._get_obs(agent_idx))
        return obs_n
    ...
    def step(self, action_n):
        ...
        for agent_id, agent in enumerate(self.agents):
            ...
            reward_n.append(self._get_reward(agent_id))
            done_n.append(self._get_done(agent_id))
            info_n = self._get_info(agent_id)
